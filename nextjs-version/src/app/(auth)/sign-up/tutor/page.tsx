...
const STEPS = [
  {
    ...
    desc: "Set up your tutor login credentials",
  },
  {
    id: 2,
    title: "Teaching Profile",
    desc: "Tell students about your expertise",
  },
  { id: 3, title: "Subjects & Grades", desc: "What subjects do you teach?" },
  {
    id: 4,
    title: "Availability & Rate",
    desc: "Set your schedule and pricing",
  },
];
...
const step4Schema = z
  ...
  .refine((d) => d.payout_method != null, {
    message: "Select a payout method",
    path: ["payout_method"],
  })
  .refine(
    (d) => {
      if (d.payout_method === "telebirr")
        return !!d.payout_phone && d.payout_phone.length >= 9;
      if (d.payout_method === "bank")
        return !!d.payout_bank && !!d.payout_account;
      return true;
    },
    {
      message: "Please complete your payout account details",
      path: ["payout_phone"],
    },
  );
...
export default function TutorRegisterPage() {
  ...
  const form4 = useForm<Step4>({
    resolver: zodResolver(step4Schema) as Resolver<Step4>,
    defaultValues: {
      hourlyRate: 150,
      maxStudents: "3",
      availableDays: [],
          ...
          <Card className="text-center">
            <CardContent className="pt-12 pb-10 space-y-4">
              ...
              <p className="text-muted-foreground text-sm max-w-xs mx-auto">
                Your profile is being reviewed. You can complete your setup from
                the dashboard.
              </p>
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      <p className="text-sm font-medium">
                        Grade Range You Cover
                      </p>
                      <p className="text-xs text-muted-foreground">
                        Students within this range can book you.
                      </p>
                      <div className="grid grid-cols-2 gap-3">
                        <FormField
                          control={form3.control}
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              >
                                <FormControl>
                                  <SelectTrigger>
                                    <SelectValue placeholder="Lowest grade" />
                                  </SelectTrigger>
                                </FormControl>
                                <SelectContent>
                                  {GRADE_OPTIONS.map((g) => (
                ...
                <Form {...form4}>
                  ...
                  >
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <p className="text-xs text-muted-foreground">
                            Minimum 50 ETB/hr. Platform takes 15% commission.
                          </p>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Where should we send your earnings after each session?
                      </p>
                      <FormField
                        control={form4.control}
                        name="payout_method"
